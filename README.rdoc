...
This is a small Rails app created for educational purposes. It is a social app which allows a user to create profiles and upload photos to them. It lists photos and profile pictures on the front page.

## Installation

1. Navigate to a local directory of your choice and clone the project with `git clone http://github.com/alexbeeken/Foto-Friends`.
